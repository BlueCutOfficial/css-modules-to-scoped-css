...
define("css-modules-to-scoped-css/tests/integration/components/welcome-page-copy-test", ["qunit", "css-modules-to-scoped-css/tests/helpers", "@ember/test-helpers", "css-modules-to-scoped-css/components/welcome-page-copy.css", "@ember/template-factory"], function (_qunit, _helpers, _testHelpers, _welcomePageCopy, _templateFactory) {
  "use strict";

  0; //eaimeta@70e063a35619d71f0,"qunit",0,"css-modules-to-scoped-css/tests/helpers",0,"@ember/test-helpers",0,"css-modules-to-scoped-css/components/welcome-page-copy.css",0,"@ember/template-factory"eaimeta@70e063a35619d71f
  (0, _qunit.module)('Integration | Component | welcome-page-copy', function (hooks) {
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      */
      ...
      assert.dom('#welcome-id').hasAttribute('class', _welcomePageCopy.default['welcome']);
      assert.equal(_welcomePageCopy.default['ember-orange'], 'rgb(255, 92, 68)', 'ember-orange color is imported');
    });
  });
});
